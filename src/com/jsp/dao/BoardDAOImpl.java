...
public class BoardDAOImpl implements BoardDAO {
	...
	public List<BoardVO> selectSearchBoardList(SqlSession session, Criteria cri) throws SQLException {
		...
		dataMap.put("searchType", searchCri.getSearchType());
		dataMap.put("keyword", searchCri.getKeyword());
		
		List<BoardVO> boardList = session.selectList("Board-Mapper.selectSearchBoardList", dataMap);
