    ...
    <section class="content">		
		<div class="card">
			<div class="card-header with-border">
				<button type="button" class="btn btn-primary" id="registBtn" onclick="OpenWindow('registForm.do','공지등록',800,700);">글 등록</button>				
				...
				<table class="table table-bordered text-center" >					
					...
					<c:if test="${!empty boardList }">					
						<c:forEach items="${boardList }" var="board">					
							<tr style='font-size:0.85em;cursor:pointer;' onclick="OpenWindow('detail.do?from=list&bno=${board.bno}', '상세 보기', '700', '800')">
								<td>${board.bno }</td>
